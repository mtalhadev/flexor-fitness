...
import { fetchPaymentHistory } from '../../../redux/actions/ClientActions';
import { useIsLoading, usePaymentHistory } from '../../../redux/reducers/ClientReducer';
...
export default function PaymentHistory() {
    ...
    return (
          ...
          <NavigationHeader 
            ...
            {_translate("followingAreThePaymentsThatYouChargedToYourTrainers")}
            </MulishText>
